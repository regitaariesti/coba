        ...
        <section class="section">
          <div class="section-header">
            <h1>MANAJEMEN ANGGOTA</h1>
                ...
                <div class="card" wire:submit.prevent="submit">
                  ...
                  @csrf
                    ...
                    <div class="card-body">
                      <div class="form-group">					  
                        <label>Nama :</label>
                        <input type="text" wire:model="nama" class="form-control" id="nama" placeholder="Masukkan nama anda" name="nama" required="">
                      ...
                      <div class="form-group">
                        <label>Alamat :</label>
                        <input type="text" wire:model="alamat" class="form-control" id="alamat" placeholder="Masukkan alamat anda" name="alamat" required="">
                        <div class="invalid-feedback">
                      ...
                      <div class="form-group">
                        <label>Telepon :</label>
                        <input type="text" wire:model="telepon" class="form-control" id="telepon" placeholder="Masukkan telepon anda" name="telepon" required="">
                        <div class="invalid-feedback">
