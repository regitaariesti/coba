...
<head>
  ...
  <title>USIP &mdash; Mekar Jaya </title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="blank.html"><i class="fas fa-rocket"></i> <span>Dashboard</span></a></li>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Selamat Datang di Usaha Simpan Pinjam Mekar Jaya!</h1>
          </div>
